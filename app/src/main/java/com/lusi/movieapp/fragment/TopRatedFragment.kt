...
import kotlinx.android.synthetic.main.fragment_top_rated.view.list_movie
import kotlinx.android.synthetic.main.fragment_top_rated.view.progress_movie
import kotlinx.android.synthetic.main.fragment_top_rated.view.scrollView
...
class TopRatedFragment : Fragment() {
    ...
    fun getMovieTopRated() {
        currentPage = 1
        showLoading(true)
        ApiService().endpoint.getMovieTopRated(Constant.API_KEY, 1)
